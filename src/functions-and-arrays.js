...
console.log('The average is', avg/(numbersAvg.length));
...
let prueba = averageWordLength(wordsArr);
console.log('The average is', prueba/(averageWordLength));
